...
void ferry() {
    ...
    while(shared->vehLeft > 0) { // active vehicle processes
        ...
        // leaving, switching port direction
...
int main(int argc, char* argv[]) {
    ...
    // checking for errors, freeing allocated on fail
    ...
    // file opening, freeing allocated on fail
